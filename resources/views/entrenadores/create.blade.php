                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('entrenadores.index') }}" class="btn btn-sm btn-primary"><i class="fas fa-arrow-circle-left"></i> Volver</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label" for="name">Apellido</label>
                                        <input type="text" id="" class="form-control" name="apellido" placeholder="Enter your Last Name" value="">
                                    </div>
                                    <div class="form-group">
